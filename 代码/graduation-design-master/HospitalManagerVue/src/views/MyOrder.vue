            ...
            <el-table :data="orderData" stripe style="width: 100%" border>
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button
                            ...
                            v-if="
                                ...
                                scope.row.oState === 1
                            "
                            @click="priceClick(scope.row.oId, scope.row.dId, scope.row.tid,scope.row.otype)"
                        >
                            点击缴费</el-button
                        >
                    </template>
                ...
                >
                    <template slot-scope="scope">
                        ...
                        <el-tag
                            type="success"
                            v-if="scope.row.oPriceState === 0 &&scope.row.oPstate === 0"
                            >未缴费</el-tag
                        >
                        <!-- <el-tag type="danger" v-if="scope.row.oPriceState === 0 && scope.row.oState === 1">未缴费</el-tag> -->
                        <el-button
                ...
                <el-table-column label="单据" width="400px">
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button
                            ...
                            style="font-size: 14px"
                            @click="seeReport(scope.row.oId, scope.row.otype, scope.row.pId)"
                            v-if="
                                scope.row.oState === 1 
                            "
                            > 指示单</el-button
                        ...
                        <el-button
                            ...
                            icon="iconfont icon-r-find"
                            style="font-size: 14px"
                            @click="seeReport2(scope.row.oId, scope.row.otype, scope.row.pId)"
                            v-if="
                                scope.row.oState === 1 &&
                                scope.row.oPriceState === 1 
                            "
    ...
    methods: {
        ...
        priceClick2(oId,otype){
            if(otype =="P"){
                ...
                request
                .get("setmealOrder/updateSetmealOrdersPrice2", {
                    params: {
                        oId: oId,
                    },
                })
