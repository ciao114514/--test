    ...
    <div>
        ...
        <el-card>
            ...
            <el-table :data="checkData" stripe style="width: 100%" border>
                <el-table-column label="类型id" prop="kid"></el-table-column>
                <el-table-column label="类型1" prop="name"></el-table-column>
                <el-table-column label="类型2" prop="kname"></el-table-column>
        ...
        <el-dialog title="增加检查项目" :visible.sync="addFormVisible">
            <el-form :model="addForm" :rules="rules" ref="ruleForm">
                ...
                <el-form-item label="类型2" label-width="80px" prop="kname">
                    <el-select v-model="addForm.kname" placeholder="请选择类型2">
                        <el-option
                            v-for="post in posts"
                            :key="post.kname"
                            :label="post.kname"
