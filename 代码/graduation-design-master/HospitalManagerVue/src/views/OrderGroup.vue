...
export default {
    ...
    methods: {
        ...
        dateClick(monthDay) {
            ...
            sessionStorage.setItem(ARRDATE, dateTime);

            this.activePath = "setmealChecks";
            setActivePath("setmealChecks");
            if (this.$route.path !== "/setmealChecks")
                this.$router.push("setmealChecks");
        },
        //获取当天及后7天的日期星期
        nowDay(num) {
