<template>
  <div>
    ...
    <!-- 病因编写对话框 -->
    <el-dialog title="病历编写" :visible.sync="reasonFormVisible">
       <!-- 身高体重 -->
       <el-form v-if="dId ==='4444'">
          
          <el-form-item label="身高(米)：" prop="sg" label-width="80px">
              <el-input v-model="updte.sg"></el-input>
          </el-form-item>
          <el-form-item label="体重(kg)：" prop="tz" label-width="80px">
              <el-input v-model="updte.tz"></el-input>
          </el-form-item>
          <el-form-item label="血压(kpa)：" prop="xy" label-width="80px">
              <el-input v-model="updte.xy"></el-input>
          </el-form-item>
          <el-form-item label="心率(bmp)：" prop="xl" label-width="80px">
              <el-input v-model="updte.xl"></el-input>
          </el-form-item>

      </el-form>
       
      <!-- 耳喉鼻 -->
      <el-form v-if="dId ==='5555'">
          <el-form-item label="听力：" label-width="80px">
                    <el-radio v-model="updte.tl" label="正常"
                        >正常</el-radio
                    >
                    <el-radio v-model="updte.tl" label="迟钝"
                        >迟钝</el-radio
                    >
                    <el-radio v-model="updte.tl" label="消失"
                        >消失</el-radio
                    >
          </el-form-item>
          <el-form-item label="左耳(米)：" prop="tname" label-width="80px">
              <el-input v-model="updte.zr"></el-input>
          </el-form-item>
          <el-form-item label="右耳(米)：" prop="price" label-width="80px">
                <el-input v-model="updte.yr"></el-input>
          </el-form-item>
          <el-form-item label="嗅觉：" label-width="80px">
                    <el-radio v-model="updte.xj" label="正常"
                        >正常</el-radio
                    >
                    <el-radio v-model="updte.xj" label="迟钝"
                        >迟钝</el-radio
                    >
                    <el-radio v-model="updte.xj" label="消失"
                        >消失</el-radio
                    >
          </el-form-item>
          <el-form-item label="口吃：" label-width="80px">
                    <el-radio v-model="updte.kc" label="正常"
                        >正常</el-radio
                    >
                    <el-radio v-model="updte.kc" label="其他"
                        >其他</el-radio
                    >
          </el-form-item>
      </el-form>
      <!-- 眼睛 -->
      <el-form v-if="dId ==='6666'">
          
          <el-form-item label="左眼：" prop="tname" label-width="80px">
              <el-input v-model="updte.zy"></el-input>
          </el-form-item>
          <el-form-item label="右眼：" prop="tname" label-width="80px">
              <el-input v-model="updte.yy"></el-input>
          </el-form-item>
          <el-form-item label="矫正左眼：" prop="tname" label-width="80px">
              <el-input v-model="updte.jzy"></el-input>
          </el-form-item>
          <el-form-item label="矫正右眼：" prop="tname" label-width="80px">
              <el-input v-model="updte.jyy"></el-input>
          </el-form-item>
          <el-form-item label="色觉：" label-width="80px">
                    <el-radio v-model="updte.sj" label="正常"
                        >正常</el-radio
                    >
                    <el-radio v-model="updte.sj" label="色弱"
                        >色弱</el-radio
                    >
                    <el-radio v-model="updte.sj" label="色盲"
                        >色盲</el-radio
                    >
          </el-form-item>
      </el-form>
      <!-- 甲状腺 -->
      <el-form v-if="dId ==='10000'">
          
          <el-form-item label="甲状腺：" label-width="80px">
                    <el-radio v-model="updte.jzx" label="正常"
                        >正常</el-radio
                    >
                    <el-radio v-model="updte.jzx" label="其他"
                        >其他</el-radio
                    >
          </el-form-item>
          <el-form-item label="淋巴：" label-width="80px">
                    <el-radio v-model="updte.lb" label="正常"
                        >正常</el-radio
                    >
                    <el-radio v-model="updte.lb" label="其他"
                        >其他</el-radio
                    >
          </el-form-item>
      </el-form>
        <!-- 肝功能 -->
        <el-form v-if="dId ==='1111'">
          
          <el-form-item label="肝功能：" label-width="80px">
                    <el-radio v-model="updte.ggn" label="正常"
                        >正常</el-radio
                    >
                    <el-radio v-model="updte.lb" label="其他"
                        >其他</el-radio
          ...
          <el-form-item label="乙肝抗原：" label-width="80px">
                    <el-radio v-model="updte.ygn" label="阴性"
                        >正常</el-radio
                    >
                    <el-radio v-model="updte.ygn" label="阳性"
                        >其他</el-radio
                    >
          </el-form-item>
      </el-form>
      <!-- 心电图 -->
      <el-form v-if="dId ==='3333'">
          <el-form-item label="心电图：" label-width="80px">
            <el-input v-model="updte.xdt"></el-input>
          </el-form-item>
          <el-form-item label="心律：" label-width="80px">
                    <el-radio v-model="updte.xn" label="正常"
                        >正常</el-radio
                    >
                    <el-radio v-model="updte.xn" label="其他"
                        >其他</el-radio
                    >
          </el-form-item>
      </el-form>
      ...
      <el-form >
          <el-form-item label="病因编写" label-width="80px">
            <el-input
              type="textarea"
               :rows="8"
               placeholder="请输入内容"
      ...
      <el-form >
          <el-form-item label="建议编写" label-width="80px">
            <el-input
              type="textarea"
               :rows="8"
              v-model="oAdvice"
  ...
  methods: {
    ...
    submitClick() {
      ...
      let data = {
        ...
        oTprice: this.dataPackage().oTotalPrice,
        otype:this.otype,
        pOid:this.pOid,
        oAdvice:this.oAdvice,
        sg:this.updte.sg,
        tz:this.updte.tz,
        xy:this.updte.xy,
        xl:this.updte.xl,
      ...
      request
        ...
        .then((res) => {
          ...
          this.$message.success("提交成功！请通知学生登录系统自助缴费！");
          if('TT'==this.otype){
            this.$router.push("setmealOrderToday");
          }else{
    ...
    dataPackage() {
      ...
      oTotalPrice = this.drugTotalPrice;
