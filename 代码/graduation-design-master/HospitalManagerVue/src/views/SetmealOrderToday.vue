<template>
    <el-card>
        <el-table :data="orderData" stripe border>
            ...
            <el-table-column label="学生id" prop="pId"></el-table-column>
            <el-table-column label="学生姓名" prop="pName"></el-table-column>
            <el-table-column label="医生姓名" prop="dName"></el-table-column>
            <el-table-column label="检查项目" prop="tname"></el-table-column>
            <el-table-column
                label="挂号时间"
                prop="oStart"
                width="200px"
            ...
            <el-table-column label="操作" fixed="right">
                <template slot-scope="scope">
                    <el-button
                        ...
                        @click="dealClick(scope.row.oId, scope.row.pId,scope.row.chid,scope.row.pOid)"
                    >
                        <i
