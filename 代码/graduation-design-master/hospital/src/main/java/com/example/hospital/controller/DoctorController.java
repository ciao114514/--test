...
public class DoctorController {
    ...
    public ResponseData findOrderByNull(@Param(value = "dId") int dId, @RequestParam(value = "oStart") String oStart,
        ...
        System.out.println("账号时间为"+dId+oStart+otype);
        return ResponseData.success("返回当天挂号信息成功", this.orderService.findOrderByNull(dId,oStart,otype));
    ...
    public ResponseData findPatientById(int pId){
        return ResponseData.success("返回学生信息成功！", this.patientService.findPatientById(pId));
    }
    /**
     * 分页根据科室查询所有医生信息
     */
