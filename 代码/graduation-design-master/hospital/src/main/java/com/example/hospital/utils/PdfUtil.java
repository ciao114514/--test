...
public class PdfUtil {
    ...
    public static void ExportPdf(HttpServletRequest request, HttpServletResponse response, Orders order) throws Exception {
       ...
       // response.setHeader("Content-Disposition", "attachment;filename=XXX.pdf");
        ...
        PdfPCell cell1 = new PdfPCell(new Paragraph(order.getOId()+"-"+ order.getDoctor().getdSection(), new Font(bfChinese, 14, Font.NORMAL)));
        cell1.setFixedHeight(25);
        cell1.setBorder(1000);
        ...
        cell3.setBorder(0);
        PdfPCell cell4 = new PdfPCell(new Paragraph(order.getTname(), new Font(bfChinese, 10, Font.NORMAL)));
        ...
        cell5.setBorder(0);
        PdfPCell cell6 = new PdfPCell(new Paragraph(order.getDoctor().getdAddress(), new Font(bfChinese, 10, Font.NORMAL)));
        cell6.setFixedHeight(30);
        cell6.setBorder(0);
        cell6.setPaddingLeft(10);
        PdfPCell cell7 = new PdfPCell(new Paragraph("金额合计："+order.getOTotalPrice(), new Font(bfChinese, 14, Font.NORMAL)));
